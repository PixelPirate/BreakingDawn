...
- (void)viewDidLoad
{
    ...
    [[NSUserDefaults standardUserDefaults] setFloat:0.006 forKey:@"AdrenalinLight"];
    [[NSUserDefaults standardUserDefaults] setFloat:0.002 forKey:@"AdrenalinDusk"];
    [[NSUserDefaults standardUserDefaults] setFloat:0.006 forKey:@"AdrenalinDark"];
